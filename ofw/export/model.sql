...
CREATE TABLE `item_frame` (
  `id` INT(11) NOT NULL AUTO_INCREMENT COMMENT 'Id único de cada frame del item',
  `id_item` INT(11) NOT NULL COMMENT 'Id del item al que pertenece el frame',
  `id_asset` INT(11) NOT NULL COMMENT 'Id del recurso usado como frame',
  `order` INT(11) NOT NULL COMMENT 'Orden del frame en la animación',
  `created_at` DATETIME NOT NULL COMMENT 'Fecha de creación del registro',
  `updated_at` DATETIME NULL COMMENT 'Fecha de última modificación del registro',
...
CREATE TABLE `scenario_object_frame` (
...
CREATE TABLE `character` (
  ...
  `respawn` INT(11) NOT NULL COMMENT 'Tiempo para que vuelva a aparecer el personaje en caso de ser un enemigo',
  `created_at` DATETIME NOT NULL COMMENT 'Fecha de creación del registro',
  `updated_at` DATETIME NULL COMMENT 'Fecha de última modificación del registro',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `equipment`
  ...
  ADD KEY `fk_equipment_item_idx` (`head`),
  ADD KEY `fk_equipment_item_idx` (`necklace`),
  ADD KEY `fk_equipment_item_idx` (`body`),
  ADD KEY `fk_equipment_item_idx` (`boots`),
  ADD KEY `fk_equipment_item_idx` (`weapon`),
  ADD CONSTRAINT `fk_equipment_game` FOREIGN KEY (`id_game`) REFERENCES `game` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_equipment_item` FOREIGN KEY (`head`) REFERENCES `item` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_equipment_item` FOREIGN KEY (`necklace`) REFERENCES `item` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_equipment_item` FOREIGN KEY (`body`) REFERENCES `item` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_equipment_item` FOREIGN KEY (`boots`) REFERENCES `item` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `character`
  ADD KEY `fk_character_asset_idx` (`id_asset_up`),
  ADD KEY `fk_character_asset_idx` (`id_asset_down`),
  ADD KEY `fk_character_asset_idx` (`id_asset_left`),
  ADD KEY `fk_character_asset_idx` (`id_asset_right`),
  ADD KEY `fk_character_item_idx` (`drop_id_item`),
  ADD CONSTRAINT `fk_character_asset` FOREIGN KEY (`id_asset_up`) REFERENCES `asset` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_character_asset` FOREIGN KEY (`id_asset_down`) REFERENCES `asset` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_character_asset` FOREIGN KEY (`id_asset_left`) REFERENCES `asset` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_character_asset` FOREIGN KEY (`id_asset_right`) REFERENCES `asset` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `connection`
  ADD KEY `fk_connection_scenario_idx` (`id_from`),
  ADD KEY `fk_connection_scenario_idx` (`id_to`),
  ADD CONSTRAINT `fk_connection_scenario` FOREIGN KEY (`id_from`) REFERENCES `scenario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_connection_scenario` FOREIGN KEY (`id_to`) REFERENCES `scenario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `scenario_object`
  ...
  ADD KEY `fk_scenario_object_asset_idx` (`id_asset_active`),
  ADD CONSTRAINT `fk_scenario_object_asset` FOREIGN KEY (`id_asset`) REFERENCES `asset` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_scenario_object_asset` FOREIGN KEY (`id_asset_active`) REFERENCES `asset` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

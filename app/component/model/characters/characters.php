<?php foreach ($values['list'] as $i => $character): ?>
	{
		...
		"blockWidth": <?php    echo !is_null($character->get('block_width'))    ? $character->get('block_width')    : 'null' ?>,
		"height": <?php echo $character->get('height') ?>,
		"blockHeight": <?php   echo !is_null($character->get('block_height'))   ? $character->get('block_height')   : 'null' ?>,
